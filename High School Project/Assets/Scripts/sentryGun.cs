...
public class sentryGun : MonoBehaviour
{
    ...
    public GameObject target, turretTopPart;
    ...
    void Update()
    {
        ...
        turretTopPart.transform.rotation = Quaternion.Slerp(turretTopPart.transform.rotation, targetRotation, Time.deltaTime * 2.0f);
